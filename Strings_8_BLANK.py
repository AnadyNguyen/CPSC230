...
print out x in this format: "Here is the combined word: 
[result]" where result is the value of x.
'''

x = input("Choose a word: ")
y = input("Choose a second word: ")
x += " " + y
print(x)
...
while x == input("Choose a character(a letter, a number, or a symbol: "):
    print(x)
    break
if x == (""):
