...
print(triangle_area(base = 1 , height = 1))
...
'''
# write your code below
# def upperCounter(my_string = input("")):
#     counter = 0
#     for i in range(len(my_string)):
#         if my_string[i].isupper():
#             counter += 1
#     message = f"{my_string} has {str(counter)} number of uppercase characters"
#     return message


def upperCounter(my_string = ()):
    counter = 0
